...
namespace QuanLyKhachSan.UserControls
{
    public partial class UserControl3 : UserControl
    {
        ...
        private void dataGridView3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt12.Text = dataGridView3.Rows[i].Cells[2].Value.ToString();
        }

        private void btnInsert_Click(object sender, EventArgs e)
        {
            command = connection.CreateCommand();
            command.CommandText = "insert into Phong values('" + txt10.Text + "', '" + txt11.Text + "', '" + txt12.Text + "')";
        ...
        {
            command = connection.CreateCommand();
            command.CommandText = "update Phong set MaP = '" + txt10.Text + "', TenP = '" + txt11.Text + "', TinhTrang = '" + txt12.Text + "' where MaP = '" + txt10.Text + "'";
            command.ExecuteNonQuery();
            loadData();
        }
